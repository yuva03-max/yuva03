...
var MoveTo = function() {
            ...
            var o = t.getAttribute("href") || t.getAttribute("data-target"),
                ...
                i = v(this.options, function(e, t) {
                    ...
                    return Object.keys(t).forEach(function(t) {
                        var n = e.getAttribute("data-mt-".concat(function(t) { return t.replace(/([A-Z])/g, function(t) { return "-" + t.toLowerCase() }) }(t)));
                        n && (o[t] = isNaN(n) ? n : parseInt(n, 10))
                    }), o
                }(t, this.options));
            "function" == typeof n && (i.callback = n);
            var a = function(t) { t.preventDefault(), e.move(r, i) };
            return t.addEventListener("click", a, !1),
                function() { return t.removeEventListener("click", a, !1) }
        }
    ...
    }, t.prototype.addEaseFunction = function(t, n) { this.easeFunctions[t] = n }, t
}();
...
! function(e, t) { "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (e = e || self).GLightbox = t() }(this, (function() {
        ...
        e.events.keyboard = a("keydown", {
            ...
            withCallback: function(t, i) {
                ...
                if (9 == n) {
                    ...
                    if (!s) { var r = z(); return void(r && (r.focus(), h(r, "focused"))) }
    ...
    function Z(e, t, i, n) {
        var s = e.querySelector(".gslide-media"),
            l = function(e) {
                ...
                return l.className = "vimeo-video gvideo", l.src = t, l.style.width = "100%", l.style.height = "100%", i && l.setAttribute("allow", i), l.onload = function() { l.onload = null, h(l, "node-ready"), T(n) && n() }, s && s.appendChild(l), l
    ...
    var U = function() {
        ...
        te = function() {
            ...
            }, { key: "clearAllEvents", value: function() { this.apiEvents.splice(0, this.apiEvents.length) } }, { key: "version", value: function() { return "3.1.0" } }]), e
        }();
    return function() {
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
            t = new te(e);
